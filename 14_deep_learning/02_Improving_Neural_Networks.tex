\section{Improving NN: Hyper-parameter tuning, Regularization, and Optimization}\label{ImprovingNeuralNetworks}
...
\end{tabular}
\caption{Train and Validation Error Rates.}
\label{tab:TrainValError}
\end{table}

...
\select
 {% #1 article + archive
  ...
  \documentclass[notitlepage, justified, openany]{tufte-book}
...
\title{Notes on Signal Processing}
\date{\today}

\select
{% #1 article + archive
  \renewcommand*{\Authfont}{\bfseries}
%  \author[1]{Michael M.~Forbes}
  \author[2]{Hossein Noorazar}
%  \author[2]{Gary Sandine}
%  \author[2]{Kevin R.~Vixie}
  \affil[1]{Department of Physics and Astronomy, Washington State University}
  \affil[2]{Center for Geometric Analysis and Data and

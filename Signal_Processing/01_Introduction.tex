...
How\citep{SingleBaraniuk} do we extract usable information from data, especially data that is full of noise and or information that has nothing to do with the information we are interested in extracting?

...
\title{Learning Notes: Machine Learning, Signal Processing, Image Analysis}
\date{\today}
...
%  \caption[][1\baselineskip]{}
  \label{fig:mugShot}
\end{figure*}
I dedicate these notes to myself. It was me who went through 
the process, even though others might have  been part of the journey.
% \newpage
% \renewcommand{\cftdot}{}
\tableofcontents

...
\[\text{power} = 1 - P(\text{Type II error}) = \frac{\text{number of false nulls that we reject}}{\text{number of false nulls}}
\]
\end{deff}
...
The Type I Type I error error rate is defined as the probability of making a Type I error given that Type I error $H_0$ holds, i.e., the probability of incorrectly rejecting $H_0$. 

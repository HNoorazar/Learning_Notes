...
Family-wise error rate is probability of making at least one such mistake when we have multiple hypothesis. Using notation of~\cref{tab:fwer1} $FWER = Pr(V \ge 1)$.
\begin{table}[h]
\label{tab:fwer1}
\centering
...
preferable. See~\cite{james2013introduction} page 567.

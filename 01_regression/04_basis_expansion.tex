\chapter{Regression: Basis Expansion}
\label{chap:Basis-Expansion}
...
%   \setfloatalignment{t} % override the location of caption t or b
\end{figure*}
...
A cubic spline has $M = 4$\sidenote{I do not understand this. A cubic spline 
...
\begin{equation}
\begin{aligned}\label{eq:truncated-power}
